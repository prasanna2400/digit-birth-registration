...
import static digit.assignment.config.ServiceConstants.*;
...
public class UserUtil {
     ...
     * The function creates user with username as username.
     *
     * @param userName
     * @param tenantId
     * @param userInfo
     */
    public void addUserDefaultFields(String userName, String tenantId, User userInfo, String userType) {
